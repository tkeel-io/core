...
type DownloadRawdataRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	StartTime int64  `protobuf:"varint,2,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	EndTime   int64  `protobuf:"varint,3,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	Marks     string `protobuf:"bytes,4,opt,name=marks,proto3" json:"marks,omitempty"`
}

func (x *DownloadRawdataRequest) Reset() {
	*x = DownloadRawdataRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_core_v1_rawdata_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DownloadRawdataRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DownloadRawdataRequest) ProtoMessage() {}

func (x *DownloadRawdataRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_core_v1_rawdata_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DownloadRawdataRequest.ProtoReflect.Descriptor instead.
func (*DownloadRawdataRequest) Descriptor() ([]byte, []int) {
	return file_api_core_v1_rawdata_proto_rawDescGZIP(), []int{3}
}

func (x *DownloadRawdataRequest) GetEntityId() string {
	if x != nil {
		return x.EntityId
	}
	return ""
...
func (x *DownloadRawdataRequest) GetStartTime() int64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *DownloadRawdataRequest) GetEndTime() int64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
func (x *DownloadRawdataRequest) GetMarks() string {
	if x != nil {
		return x.Marks
	}
	return ""
...
type DownloadRawdataResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DownloadRawdataResponse) Reset() {
	*x = DownloadRawdataResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_core_v1_rawdata_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DownloadRawdataResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DownloadRawdataResponse) ProtoMessage() {}

func (x *DownloadRawdataResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_core_v1_rawdata_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DownloadRawdataResponse.ProtoReflect.Descriptor instead.
func (*DownloadRawdataResponse) Descriptor() ([]byte, []int) {
	return file_api_core_v1_rawdata_proto_rawDescGZIP(), []int{4}
}

func (x *DownloadRawdataResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *DownloadRawdataResponse) GetLength() string {
	if x != nil {
		return x.Length
	}
	return ""
...
func (x *DownloadRawdataResponse) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
var file_api_core_v1_rawdata_proto_rawDesc = []byte{
	...
	,
...
var file_api_core_v1_rawdata_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_core_v1_rawdata_proto_goTypes = []interface{}{
	...
	(*DownloadRawdataRequest)(nil),  // 3: api.core.v1.DownloadRawdataRequest
	(*DownloadRawdataResponse)(nil), // 4: api.core.v1.DownloadRawdataResponse
	nil,                             // 5: api.core.v1.GetRawdataRequest.FiltersEntry
}
var file_api_core_v1_rawdata_proto_depIdxs = []int32{
	5, // 0: api.core.v1.GetRawdataRequest.filters:type_name -> api.core.v1.GetRawdataRequest.FiltersEntry
	...
	3, // 3: api.core.v1.Rawdata.DownloadRawdata:input_type -> api.core.v1.DownloadRawdataRequest
	1, // 4: api.core.v1.Rawdata.GetRawdata:output_type -> api.core.v1.GetRawdataResponse
	4, // 5: api.core.v1.Rawdata.DownloadRawdata:output_type -> api.core.v1.DownloadRawdataResponse
...
func file_api_core_v1_rawdata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_core_v1_rawdata_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DownloadRawdataRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_core_v1_rawdata_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DownloadRawdataResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
type RawdataHTTPHandler struct {
	srv RawdataHTTPServer
}
...
func (h *RawdataHTTPHandler) GetRawdata(req *go_restful.Request, resp *go_restful.Response) {
	...
	out, err := h.srv.GetRawdata(ctx, &in)
	if err != nil {
...
func RegisterRawdataHTTPServer(container *go_restful.Container, srv RawdataHTTPServer) {
